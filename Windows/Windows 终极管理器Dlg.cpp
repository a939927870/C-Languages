// Windows 终极管理器Dlg.cpp : implementation file
//

#include "stdafx.h"
#include "Windows 终极管理器.h"
#include "Windows 终极管理器Dlg.h"
...
void CWindowsDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CWindowsDlg::OnQueryDragIcon()
{
